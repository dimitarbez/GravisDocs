...
import { FaCode, FaMicrochip, FaExternalLinkAlt } from 'react-icons/fa';
import { motion } from 'framer-motion';
import electronicsImage from '../../../images/gravis_chassis_render_occlusion.jpg'; // Ensure the path is correct
import ModelsSection from '../../../components/ModelsSection'; // Import the ModelsSection
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Access comprehensive code, detailed comments, and guidelines to understand and replicate the Gravis project seamlessly.
            </p>
            <div className="space-y-4">
              ...
              <div>
                ...
                <a
                  href="/code-documentation" // Update the link as necessary
              ...
              <div>
                ...
                <ol className="list-decimal list-inside text-gray-600 dark:text-gray-300 mt-2 space-y-2">
                  <li>
                    ...
                    <a
                      href="https://github.com/dimitarbez/GravisMicrocontroller" // Update the link as necessary
        ...
        <section className="mb-16">
          ...
          >
            ...
            <img
              src={electronicsImage} // Ensure this path is correct or replace with your image path
              alt="Electronics Schematic"
      ...
      <footer className="bg-gray-800 dark:bg-gray-900 text-gray-300 py-6">
        <div className="container mx-auto text-center">
          ...
          <div className="mt-4 flex justify-center space-x-4">
            {/* GitHub Icon */}
            <a
              href="https://github.com/your-repo" // Update the link as necessary
              target="_blank"
            ...
            {/* Twitter Icon */}
            <a
              href="https://twitter.com/your-profile" // Update the link as necessary
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white transition-colors duration-200"
              aria-label="Twitter"
            ...
            {/* LinkedIn Icon */}
            <a
              href="https://linkedin.com/in/your-profile" // Update the link as necessary
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white transition-colors duration-200"
              aria-label="LinkedIn"
